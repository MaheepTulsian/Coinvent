...
const SignUpForm = () => {
  ...
  //   uploadImageToCloudinary(imageFile).then(imageUrl => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        const response = await fetch('http://localhost:3000/organisations/createEvent/IIT', {
          method: 'POST',
          headers: {
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            value={formik.values.event_title} onChange={formik.handleChange}
          />
        </div>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            rows="4"
            className="mt-1 p-2 w-full border rounded-md"
            value={formik.values.rule_regulation} onChange={formik.handleChange}
          />
        </div>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            name="eligibility"
            className="mt-1 p-2 w-full border rounded-md"
            value={formik.values.eligibility} onChange={formik.handleChange}
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          <div>
            ...
            <input
              ...
              className="mt-1 p-2 w-full border rounded-md"
              value={formik.values.max_tickets_available} onChange={formik.handleChange}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              name="ticket_price"
              className="mt-1 p-2 w-full border rounded-md"
              value={formik.values.ticket_price} onChange={formik.handleChange}
            />
          </div>
        </div>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="mt-1 p-2 w-full border rounded-md"
            value={formik.values.max_ticket_per_person} onChange={formik.handleChange}
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          ...
          <div className="mt-4">
            ...
            <input
              ...
              className="mt-1 p-2 w-full border rounded-md"
              value={formik.values.event_start_date} onChange={formik.handleChange}
            />
          </div>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              name="event_end_date"
              className="mt-1 p-2 w-full border rounded-md"
              value={formik.values.event_end_date} onChange={formik.handleChange}
            />
          </div>
        </div>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            name="event_venue"
            className="mt-1 p-2 w-full border rounded-md"
            value={formik.values.event_venue} onChange={formik.handleChange}
          />
        </div>
